...
def main_thread(master):
    ...
    # will be replaced with something more configurable later
    try:
        ...
        # Used after implementing makeTrigger:
        triggerlist = readTriggerConfig("G:/Python_work/code_ProblemSet7/ProblemSet7/triggers.txt")
